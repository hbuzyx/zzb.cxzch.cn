...
<div class="n_cont c">
 ...
 $_sname = ""; $_typeid = -1; if($_typeid == -1) $_typeid = I('cid', 0, 'intval'); if ($_typeid == 0 && $_sname == '') { $_sname = isset($title) ? $title : ''; } echo get_position($_typeid, $_sname, "", 0, "&nbsp;&gt;&nbsp;"); ?> &gt; </span> </div>
      ...
      <div class="bjbld">
         <!--<div class="yxxqab">
        <?php if(is_array($content['pictureurls'])): foreach($content['pictureurls'] as $key=>$v): ?><img src="<?php echo (get_picture($v['url'],600)); ?>" width="448" height="308" alt=""><?php endforeach; endif; ?>
          <div class="gcxqs">
            <div class="vsjwe"><?php echo ($content["title"]); ?></div>
            <div class="vsjws"><?php echo ($content["contents"]); ?></div>
          </div>
        </div>
        <div class="anljj"> 简介&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;∨ </div>-->
        <div class="nrns">
          <img alt="" src="<?php echo ($content["picture"]); ?>"><br>
<div>
