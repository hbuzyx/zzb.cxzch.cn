...
<div class="head">
<div class="top_logo"> <span style="color:#FFF; font-size:34px; height:60px; line-height:60px;">紫塞先锋 </span></div>
	 ...
	 <div class="top_link">
      <ul>
        ...
        <li id="i_hide_menu"><a href="<?php echo U('System/clearCache');?>" target="main" >清除缓存</a></li>	
      </ul>
    </div>
</div>
<!-- header end -->
