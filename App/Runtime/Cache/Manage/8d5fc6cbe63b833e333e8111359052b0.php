...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Guestbook';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Guestbook/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php echo ($v["homepage"]); ?></td>
                            <td>
                            	<p>
                                <strong>姓名：</strong><?php if($v['userid']): ?><a href="<?php echo ($v["userid"]); ?>" target="_blank"><?php echo ($v["username"]); ?></a><?php else: echo ($v["username"]); endif; ?>
                                <strong>来自：</strong><?php echo ($v["ip"]); ?> <strong>电话：</strong><?php echo ($v["tel"]); ?> <strong>QQ：</strong><?php echo ($v["qq"]); ?><br/>
                                </p>
                            </td>
                            <td>
                                <p>
                                <strong>留言：</strong><?php echo ($v["content"]); ?> [<?php echo (date('Y-m-d H:i:s', $v["posttime"])); ?>]<br/>
                                </p>
                                <?php if($v['replytime']): ?><p>
