...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Union';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Union/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加广告</button>
            </div>
        </div>
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            <td><?php echo ($v["id"]); ?></td>
                            <td><a href="<?php echo U('edit',array('id' => $v['id']), '');?>"><?php echo ($v["name"]); ?></a></td>             
                            <td><?php echo (date('Y-m-d H:i:s', $v["publishtime"])); ?></td>
                            <td><?php if($v['status']): ?><font color="green">启用</font><?php else: ?><font color="red">关闭</font><?php endif; ?></td>
                            <td class="text-right">
