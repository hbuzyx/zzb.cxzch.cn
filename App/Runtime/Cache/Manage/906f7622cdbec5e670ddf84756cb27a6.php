...
<head>
	...
	<script language="JavaScript">
	    ...
	    var SELF='/xn_admin.php?s=/Collect/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add');?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加规则</button>
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td><?php echo (get_catename($v["cid"])); ?></td>
                            <td><?php echo ($v["url"]); ?></td>
                            <td><?php echo ($v["firstpage"]); ?>~<?php echo ($v["lastpage"]); ?>页</td>
                            <td><?php echo (date('Y-m-d H:i:s', $v["posttime"])); ?></td>
                            <td class="text-right">
                            	<a href="<?php echo U('caiji',array('id' => $v['id']), '');?>" class="label label-success">立即采集</a>
