...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Database';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Database/index';
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <td class="text-right">
                                <a href="<?php echo U('optimize',array('tablename' => $v['name']), '');?>" class="label label-info">优化</a>
                                <a href="<?php echo U('repair',array('tablename' => $v['name']), '');?>" class="label label-success">修复</a>                          
                            </td>
