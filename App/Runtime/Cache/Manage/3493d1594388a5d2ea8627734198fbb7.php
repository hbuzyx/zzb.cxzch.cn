...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Special';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Special/index';
...
<body>
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            ...
            <?php if(ACTION_NAME == "index"): ?><button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加专题</button>                 
                ...
                <div class="table-responsive">
                    <table class="table table-hover xyh-table-bordered-out">
                        ...
                        <?php if(is_array($vlist)): foreach($vlist as $key=>$v): ?><tr>
                            ...
                            <a href="javascript:;" onclick="toConfirm('<?php echo U('del',array('id' => $v['id'],'pid' => $pid,'p' => $_GET['p']), '');?>', '确实要彻底删除吗？')" class="label label-danger">删除</a>
                            <?php else: ?>
                            <a href="<?php echo U('edit',array('id' => $v['id'],'pid' => $pid,'p' => $_GET['p']), '');?>" class="label label-success">编辑</a>
