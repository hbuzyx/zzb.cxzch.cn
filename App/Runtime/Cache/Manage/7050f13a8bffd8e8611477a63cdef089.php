...
<head>
	...
	<script language="JavaScript">
	    ...
	    var SELF='/xn_admin.php?s=/Category/index';
    ...
    <div class="row margin-botton">
        <div class="col-md-6 column">
            <div class="btn-group btn-group-md">
                 ...
                 <button class="btn btn-default" type="button" onclick="doGoSubmit('<?php echo U('Category/sort');?>','form_do')"><em class="glyphicon glyphicon-refresh"></em> 更新排序</button>
            </div>
        </div>
    </div>
