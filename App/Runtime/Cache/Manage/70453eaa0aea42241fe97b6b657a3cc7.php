...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Abc';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Abc/index';
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            <div class="btn-group btn-group-md">
                <button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加广告位</button>
            </div>
        </div>
