...
<head>
	...
	<script language="JavaScript">
	    <!--
	    var URL = '/xn_admin.php?s=/Article';
	    var APP	 = '/xn_admin.php?s=';
	    var SELF='/xn_admin.php?s=/Article/index/pid/42';
...
<body>
    ...
    <div class="row margin-botton">
        <div class="col-sm-6 column">
            ...
            <?php if(ACTION_NAME == "index"): if(!$subcate): ?><button class="btn btn-primary" type="button" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加文章</button>
                <?php else: ?>
                <button class="btn btn-primary" type="button" disabled="disabled" title="封面页不能添加内容" onclick="goUrl('<?php echo U('add', array('pid'=>$pid));?>')"><em class="glyphicon glyphicon-plus-sign"></em> 添加文章</button><?php endif; ?>
